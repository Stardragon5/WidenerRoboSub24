...
#Callback Function for raw subscriber
def callback_raw(imu_raw):
    global accel_x
    accel_x = imu_raw.linear_acceleration.x
    accel_y = imu_raw.linear_acceleration.y
    accel_z = imu_raw.linear_acceleration.z
...
if __name__ == '__main__':
    ...
    #Set up Subscriber
    sub_raw = rospy.Subscriber("imu/raw", Imu, callback_raw) #
